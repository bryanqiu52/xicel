...
'          </div>',
    ...
    '            </a>',
    '            <div class="flex flex-wrap gap-1.5 mt-2 px-0.5">',
    '              <a href="products-design.html?subtab=brand" class="text-xs px-2 py-0.5 bg-white rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline">品牌设计</a>',
    '              <a href="products-design.html?subtab=packaging" class="text-xs px-2 py-0.5 bg-white rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline">包装设计</a>',
    '              <a href="products-design.html?subtab=ecommerce" class="text-xs px-2 py-0.5 bg-white rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline">电商设计</a>',
    '            </div>',
    '            <div class="flex flex-wrap gap-1.5 mt-1.5 px-0.5">',
    '              <a href="products-design.html?subtab=material" class="text-xs px-2 py-0.5 bg-white rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline">线下物料</a>',
    '              <a href="products-design.html?subtab=ui" class="text-xs px-2 py-0.5 bg-white rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline">UI/UX设计</a>',
    '            </div>',
    '          </div>',
...
'        </div>',
    ...
    '        <div class="flex flex-wrap gap-1.5 pl-4 mt-1.5">',
    '          <a href="products-design.html?subtab=brand" class="text-xs px-2 py-0.5 bg-slate-100 rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline" onclick="closeMobileMenu()">品牌设计</a>',
    '          <a href="products-design.html?subtab=packaging" class="text-xs px-2 py-0.5 bg-slate-100 rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline" onclick="closeMobileMenu()">包装设计</a>',
    '          <a href="products-design.html?subtab=ecommerce" class="text-xs px-2 py-0.5 bg-slate-100 rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline" onclick="closeMobileMenu()">电商设计</a>',
    '        </div>',
    '        <div class="flex flex-wrap gap-1.5 pl-4 mt-1.5">',
    '          <a href="products-design.html?subtab=material" class="text-xs px-2 py-0.5 bg-slate-100 rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline" onclick="closeMobileMenu()">线下物料</a>',
    '          <a href="products-design.html?subtab=ui" class="text-xs px-2 py-0.5 bg-slate-100 rounded text-muted hover:bg-rose-100 hover:text-rose-600 transition-colors no-underline" onclick="closeMobileMenu()">UI/UX设计</a>',
    '        </div>',
    '      </div>',
